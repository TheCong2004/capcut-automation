...
const SDK_JS_PACKAGE_JSON: &str = include_str!(concat!(
    ...
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/package.json"
));
const SDK_JS_INDEX: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/index.js"
));
const SDK_JS_RUNTIME: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/runtime.js"
));
const SDK_JS_RUNTIME_CLI: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/runtime-cli.js"
));
...
const SDK_JS_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/index.d.ts"
));
const SDK_JS_RUNTIME_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/runtime.d.ts"
));
const SDK_JS_RUNTIME_CLI_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/runtime-cli.d.ts"
));
const SDK_JS_AI_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/ai.d.ts"
));
const SDK_JS_MANIFEST: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/manifest.js"
));
const SDK_JS_MANIFEST_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/manifest.d.ts"
));
const SDK_JS_COMPATIBILITY: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/compatibility.js"
));
const SDK_JS_COMPATIBILITY_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/compatibility.d.ts"
));
const SDK_JS_SCHEMA: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/schema.js"
));
const SDK_JS_SCHEMA_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/schema.d.ts"
));
const SDK_JS_SHARED_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/types.d.ts"
));
const SDK_JS_SHARED_RUNTIME_TYPES: &str = include_str!(concat!(
    env!("CARGO_MANIFEST_DIR"),
    "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/dist/types.js"
));
const SDK_JS_README: &str =
    include_str!(concat!(env!("CARGO_MANIFEST_DIR"), "/../frontend/apps/artcraft/app/src/pages/PageYouwee/sdk-js/README.md"));
